...
export default function reducer(state = { data: null, fetching: false, fetched: false, fieldData: null, focusedField: null, systemWineData: null, initialValue: null }, action) {
  switch (action.type) {
